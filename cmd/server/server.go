...
func Main() {
	...
	parser.ShortDescription = "Test Biofarma"
	parser.LongDescription = "Test Biofarma"
	...
	handler := alice.New(
		middlewares.NewRecoveryMW("Test-Biofarma", nil),
